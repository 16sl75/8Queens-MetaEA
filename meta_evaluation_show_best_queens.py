...
def pipeline(num, *args):
    ...
    func_list = [parent_selection.MPS, parent_selection.tournament, parent_selection.random_uniform,
                 ...
                 survivor_selection.replacement, survivor_selection.random_uniform, meta_evaluation_show_best_queens]
...
def meta_evaluation_show_best_queens(meta_individual):
    ...
    return meta_fitness,Success_queens
